<div>
    ...
    <div class="w-full h-screen bg-white py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with Liang Ke <span class="text-red-600">888</span></h1>
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
            <div class="flex flex-wrap items-center">
                @foreach ($menus as $menu)
                    <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3 bg-white" wire:key="{{ $menu->id }}">
                        {{-- <div class="border border-gray-300 dark:border-gray-700"> --}}
                        <div class="relative bg-gray-200">
                            <a class="">
                                <img src="{{ url('storage', $menu->images) }}" alt="{{ $menu->name }}"
                        ...
                        <div class="p-3 ">
                            ...
                            <p class="text-lg ">
                                <span
                                    class="text-green-600 dark:text-green-600">{{ Number::currency($menu->price, 'IDR') }}</span>
                            </p>
                        </div>
                        <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">

                            <a wire:click.prevent='addToCart({{ $menu->id }})' href="#"
                                ...
                                <span wire:loading.remove wire:target="addToCart({{ $menu->id }})">Add to
                                    Cart</span> <span wire:loading
                                    wire:target="addToCart({{ $menu->id }})">Adding...</span>
                            </a>
